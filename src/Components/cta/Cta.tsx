...
const Cta = () => {
  ...
  <div className="pt-6">
    <h2 className='text-4xl'>Get Started in 3 Easy Steps</h2>
    <p>Liteweb Engine comes With Integrations like: Mailchimp, Campaign Monster etc</p>
...
<div className="flex gap-3 items-center">
  <span className="text-green-500"><FaCheck /></span>
  <span className="text-sm">Choose and Customize your blocks</span>
</div>
{/* @comp end */}
{/* @comp */}
<div className="flex gap-3 items-center">
  <span className="text-green-500"><FaCheck /></span>
  <span className="text-sm">Push or Export your code</span>
</div>
{/* @comp end */}
    </div>
  </div>
