...
const Pricing = () => {
 ...
 <h2><span className='text-5xl font-[500] text-primary'>₦{isMonth? "5":"51"}k</span> <span className="text-xs opacity-60">/ {isMonth ? "month":"year"}</span></h2>
 ...
 <h2><span className='text-5xl font-[500] text-primary'>₦{isMonth?"10":"102"}K</span> <span className="text-xs opacity-60">/ {isMonth ? "month":"year"}</span></h2>
 ...
 <h2><span className='text-5xl font-[500] text-primary'>₦{isMonth?"15":"153"}k</span> <span className="text-xs opacity-60">/ {isMonth ? "month":"year"}</span></h2>
