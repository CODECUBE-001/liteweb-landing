  ...
  <Header />
    ...
    {/* hero */}
        <div className="text-center py-10">
          <h1 className="w-[650px] mx-auto text-bold text-5xl">
        ...
        <p className="w-[500px] m-auto text-sm py-3">Lorem ipsum dolor sit amet consectetur adipisicing elit. Minima nulla ipsum necessitatibus beatae! Velit facere similique quae, enim esse quam.</p>

        <button className="w-[90px] h-[90px] flex justify-center items-center text-2xl bg-primary rounded-full  mx-auto">
          <ArrowDown />
        </button>
      ...
      <section className="my-12 py-12">
        <div className='flex relative py-12 justify-around'>
          {/* @comp */}
        ...
        <div className='flex relative flex-row-reverse py-12 justify-around'>
          {/* @comp */}
          <div className="w-[400px]">
            <h3 className="text-5xl">
              Built for the way you work
      ...
      <section className="p-12 my-12 bg-[#043534] overflow-hidden" style={{
        background:'linear-gradient(0deg, #054342,black, black )'
      }}>
        <h1 className="text-center text-5xl max-w-[750px] mx-auto my-3">
...
Get to know them.
    ...
    <div className="template-demos h-[400px] my-5">
      <img src={dashboard} alt="" className='w-3/4 mx-auto' />
      {/* template image */}
...
<div className="text-center">
  <h1 className=' text-5xl max-w-[750px] py-1 mx-auto'>It's Easy to Get Started</h1>
...
<div className="p-6 flex mt-12 justify-center items-center gap-9">
...
<div className="w-[300px] scale-[1.2] h-[400px] bg-primary">
...
<section className="text-center py-12 h-[600px] bg-primary/50  overflow-hidden">
  <div className="pt-6">
...
{/* @comp end */}
  ...
  <div className="">
  <img src={dashboard} alt="" className='w-3/4 mx-auto mt-12' />
  </div>
</section>
...
{/* faq */}
<section className="flex p-6 gap-6 py-12 justify-around">
<div className="">
  <h3 className="text-5xl w-[400px]">Frquently Asked Questions</h3>
  <p className='text-xs py-2 w-[400px]'>Have Questions not listed here?, Contact our team and we'll be happy to help : )</p>
<button className='bg-gray-800 text-sm w-[150px] rounded-sm shadow-sm block py-3 my-2'>Contact Us</button>
</div>
<div className="max-w-[450px]">
  {/* faqs */}
  
  <div className="flex justify-between gap-5 my-5 items-center p-4 px-8 rounded-full bg-gray-900">
    <span className="text-md">Can I Cancel or Change Plans at Anytime ?</span>
    <span className=""><FaAngleDown /></span>
  </div>
  
  <div className="flex justify-between gap-5 my-5 items-center p-4 px-8 rounded-full bg-gray-900">
    <span className="text-md">Does Lite web works on mobile ?</span>
    <span className=""><FaAngleDown /></span>
  </div>
  
  <div className="flex justify-between gap-5 my-5 items-center p-4 px-8 rounded-full bg-gray-900">
    <span className="text-md">Is there a free or Trial version ?</span>
    <span className=""><FaAngleDown /></span>
  </div>
  
  <div className="flex justify-between gap-5 my-5 items-center p-4 px-8 rounded-full bg-gray-900">
    <span className="text-md">Can I Export it to .TSX file ?</span>
    <span className=""><FaAngleDown /></span>
  </div>
  
  <div className="flex justify-between gap-5 my-5 items-center p-4 px-8 rounded-full bg-gray-900">
    <span className="text-md">Do i need to have basic knowlegde in programing ?</span>
    <span className=""><FaAngleDown /></span>
  </div>
  ...
  {/* footer */}
      ...
      <div className="">
        ...
        <h3 className="text-5xl w-[700px] py-4"><span className="text-primary">Subscribe</span> to our newsletter to stay in touch tith us</h3>
        <div className="">
          <input type="text" placeholder='Enter Here' className='py-3 text-4xl bg-transparent outline-none' />
        </div>
      </div>
      </footer>
